            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <label>Tên</label>
                  <input type="text" class="form-control" name="name" value="<?= $productID->name ?>">
                </div>
                <div class="form-group">
                  <label>Giá</label>
                  <input type="number" class="form-control" name="price" value="<?= $productID->price ?>">
                </div>
                <div class="form-group">
                  <label>Mô tả ngắn</label>
                  <textarea name="description" class="form-control" rows="3"><?= $productID->description ?></textarea>
                </div>
                <div class="form-group">
                  ...
                  <div class="card-body">
                    <textarea id="detail_description" name="detail_description"><?= $productID->detail_description ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="options[1]" value="<?= $productID->options_sizes ?>">
                </div>
                <div class="form-group">
                  <label>Màu(phân cách nhau bởi dấu ',')</label>
                  <input type="text" class="form-control" name="options[2]" value="<?= $productID->options_colours ?>">
                </div>
              </div>
              <!-- xử lý category -->
              <div class="row">
